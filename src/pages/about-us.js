            ...
            <div className="grid sm:grid-cols-2 gap-x-5 gap-y-8 lg:grid-cols-6 xl:gap-x-8">
              ...
              <div className="max-w-sm">
                ...
                <div className="py-4">
                  ...
                  <span className="opacity-75 text-base">Chief Executive</span>
                </div>
              </div>
              <div className="max-w-sm">
                <Image
              ...
              <div className="max-w-sm">
                ...
                <div className="py-4">
                  ...
                  <span className="opacity-75 text-base">HR Officer</span>
                </div>
              </div>
              <div className="max-w-sm">
                <Image
                ...
                <div className="py-4">
                  ...
                  <span className="opacity-75 text-base">Lead Developer</span>
                </div>
              </div>
            </div>
          </div>
