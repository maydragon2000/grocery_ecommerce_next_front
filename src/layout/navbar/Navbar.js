...
const Navbar = () => {
  ...
  const [showSearchPart, setShowSearchPart] = useState(true);
  ...
  useEffect(() => {
    ...
    if(page === "/" && width < 1024){
      setShowSearchPart(false)
    } else {
      setShowSearchPart(true);
    }
  }, []);
    ...
    <>
      ...
      {showHi && 
        <div className="bg-white sm:bg-primary sticky top-0 z-20">
          {showSearchPart &&
            <div className="max-w-screen-2xl mx-auto px-3 sm:px-10 nav_search_part">
